...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"classes/select.js":[function(require,module,exports) {
"use strict";
...
var getTemplateSelect = function getTemplateSelect(placeholder, items, selectedId) {
  ...
  var list = items.map(function (item) {
    ...
    return "<li class=\"select__dropdown-item ".concat(cls, "\" data-type=\"value\" data-id=\"").concat(item.id, "\">").concat(item.value, "</li>");
  });
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    value: function select(id) {
      ...
      this.$el.querySelectorAll('[data-id]').forEach(function (item) {
...
window.s = select;
},{"./classes/select":"classes/select.js","./styles.scss":"styles.scss"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/select-plugin%20project.e31bb0bc.js.map